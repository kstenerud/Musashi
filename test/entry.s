...
* m68k-elf-ld -Ttext 0 --oformat binary -o test.bin file.o
* m68k-elf-objdump -D test.bin -b binary -mm68k:68040


* Memory layout:
* 0x0-0x400: RAM, contains vector table and stack
* 0x400-...: ROM, code
* 0x10000-0x11000: RAM, some tests write here
* 0xF0000-0xF1000: RAM, some tests write here
...
.set MUSASHI,       0x100010        | This long is set to 1 if we are running with Musashi. Use to blacklist tests.
